    ...
    public function __construct() {
        ...
        switch ($cpt) {
            case 7 : 
                ...
                $result2 = mysqli_query($this->co,"SELECT * FROM parent WHERE pseudo = '$this->username' AND mdpasse = '$this->pwd'") or die("Erreur lors de la requete de recherche du membre");
            ...
            case 3 :
                ...
                $result = mysqli_query($this->co,"SELECT * FROM parent WHERE pseudo = '$this->username' AND mdpasse = '$this->pwd'") or die("Erreur lors de la requete de recherche du membre");
