        ...
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <div class="jumbotron">
              ...
              <br>
              <form class="" action="../Controleur/controleur_ajout_all_enfants.php" method="post" id="ajout">
                ...
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1" required="">Parent</span>
                  </div>
                    <?php require_once("../Controleur/controleur_ajout_all_enfants.php"); display_parents(); ?>
                </div>
